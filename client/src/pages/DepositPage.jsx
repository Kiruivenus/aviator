  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
        ...
        {/* Left Column: Form & Header (7 cols on desktop) */}
        <div className="lg:col-span-7 space-y-5">
          ...
          {/* Deposit Main Form Card */}
          <div className="bg-[#1c2530] border border-slate-800/80 rounded-2xl p-6 sm:p-8 shadow-xl space-y-6">
            <div>
            ...
            <form onSubmit={handleMpesaDeposit} className="space-y-5">
              ...
              <div className="bg-[#111720] border border-slate-800 rounded-xl p-3 flex items-center justify-between">
                <button
                  type="button"
                ...
                <input
                  ...
                  className="w-full bg-transparent text-center font-bold text-white text-base sm:text-xl focus:outline-none placeholder-slate-500 font-mono"
                />
              ...
              <div className="grid grid-cols-4 gap-2.5 pt-1">
                {[100, 200, 500, 1000].map((val) => (
                  <button
                    ...
                    className="bg-[#273546] hover:bg-[#32445a] text-white font-extrabold text-sm py-3 rounded-full transition-all font-mono active:scale-95 shadow-sm min-h-[42px]"
                  >
                    +{val}
                  </button>
                ))}
        ...
        {/* Right Column: Balance Summary & My Transactions (5 cols on desktop) */}
        <div className="lg:col-span-5 space-y-5">
          {/* Balance & Bonus Summary Card */}
          <div className="bg-[#1c2530] border border-slate-800/80 rounded-2xl p-5 sm:p-6 shadow-xl flex items-center justify-between">
            {/* Left: Balance */}
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 flex items-center justify-center">
          ...
          <div className="bg-[#1c2530] border border-slate-800/80 rounded-2xl p-5 sm:p-6 shadow-xl space-y-4">
            <div

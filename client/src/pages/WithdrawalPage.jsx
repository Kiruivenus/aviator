  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
        ...
        {/* Left Column: Withdrawal Form & Header (7 cols on desktop) */}
        <div className="lg:col-span-7 space-y-5">
          ...
          <div className="bg-[#1c2530] border border-slate-800/80 rounded-2xl p-6 sm:p-8 shadow-xl space-y-6">
            ...
            <form onSubmit={handleMpesaWithdrawal} className="space-y-5">
              ...
              {/* Subtext */}
              <p className="text-xs text-slate-400 font-medium text-left leading-relaxed">
